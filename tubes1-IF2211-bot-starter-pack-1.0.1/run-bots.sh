...
python main.py --logic BrainNotFound --email=alieff@email.com --name=BNF --password=123456 --team etimo &
python main.py --logic Directpy --email=martino@email.com --name=martino --password=123456 --team etimo &
python main.py --logic Tackle --email=habbi@email.com --name=habbi --password=123456 --team etimo &